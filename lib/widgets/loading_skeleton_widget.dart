    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const LoadingSkeletonWidget(width: double.infinity, height: 280),
          const SizedBox(height: 24),
          const LoadingSkeletonWidget(width: double.infinity, height: 200),
          const SizedBox(height: 24),
          const LoadingSkeletonWidget(width: double.infinity, height: 160),
        ],
      ),
    );
  }
